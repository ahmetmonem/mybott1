...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/launch', ['launch/launch_sim.launch.py']),  # زيد هنا ملفات اللانش المطلوبة
        ('share/' + package_name + '/config', [
            'config/fire_detection_params.yaml',
            'config/my_controllers.yaml',
            # أضف باقي ملفات الكونفيج التي تحتاجها
        ]),
        ('share/' + package_name + '/description', [
            'description/robot.urdf.xacro',
            'description/gazebo_control.xacro',
            # أضف باقي ملفات الوصف
        ]),
        ('share/' + package_name + '/worlds', [
            'worlds/empty.world',
            'worlds/fire_world.world',
            # أضف باقي ملفات العوالم
        ]),
    ],
